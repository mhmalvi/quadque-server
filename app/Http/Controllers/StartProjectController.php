...
class StartProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // });
        try {
            Mail::to($email)->cc('ceo@quadque.tech')->send(new StartProject($email, $name, $phone, $category, $sub_categories, $help));
            Mail::to('info@quadque.tech')->cc('ceo@quadque.tech')->send(new Credential($email, $name, $phone, $category, $sub_categories, $help));
            // dd($result);
