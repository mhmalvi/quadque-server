...
Vue.component(
    "products-component",
    require("./components/admin/products.vue").default
);
Vue.component(
    "gallery-component",
...
Vue.component(
    "jobs-component",
    require("./components/admin/jobs.vue").default
);
...
} else if (location.hostname == "qqtech-server.quadque.digital") {
    Vue.prototype.$base = "https://qqtech-server.quadque.digital/public/";
} else {
    Vue.prototype.$base = location.origin + "/public/";
}
