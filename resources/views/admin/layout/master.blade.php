        ...
        <nav style="padding-inline: 2%;" class="navbar navbar-expand-lg navbar-light bg-dark text-white">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav text-white" id="nav">
                    ...
                    <li class="{{ request()->routeIs('admin.products') ? 'active' : '' }} nav-item">
                    ...
                    <li class="{{ request()->routeIs('admin.jobs.get') ? 'active' : '' }} nav-item">


                        <a class="nav-link text-white" href="{{ route('admin.jobs.get') }}">Jobs</a>
