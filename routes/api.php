...
Route::post('counter', [HomeApiController::class, 'counter']);
Route::get('get-counter', [HomeApiController::class, 'get_count']);
...
Route::post('get-meta-tags', [BlogApiController::class, 'get_meta_tags']);
...
Route::get('solved-problems', [ProductController::class, 'get_solved_problems_api']);

Route::get('product', [ProductController::class, 'get_all']);
Route::get('product_id={id}/product-by-id', [ProductController::class, 'get_product_by_id']);
Route::post('product-store',[ProductController::class,'store']);
Route::get('product-delete-all/{id}', [ProductController::class, 'destroy']);
