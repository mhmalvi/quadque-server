...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['guest:admin', 'preventBackHistory'])->group(function () {
        Route::get('/blog/blog-details/{slug}', [BlogController::class, 'blog_details']);
    ...
    Route::middleware(['auth:admin', 'preventBackHistory'])->group(function () {
        ...
        Route::get('/product', [ProductController::class, 'product_admin_view'])->name('products');
        Route::get('/products', [ProductController::class, 'index'])->name('product.get');
        Route::get('/solved-problems', [ProductController::class, 'get_solved_problems']);
        Route::post('/product/store', [ProductController::class, 'store'])->name('product.store');
        Route::post('/plan/store', [ProductController::class, 'plan_insert']);
        Route::post('/plan_id={id}/plan-update', [ProductController::class, 'update_plan']);
        Route::post('/feature/store', [ProductController::class, 'features_save']);
        Route::post('/feature_id={id}/feature-update/', [ProductController::class, 'feature_update']);
        Route::get('/product/id={id}/edit', [ProductController::class, 'edit']);
        Route::post('/product/product_id={id}/update/', [ProductController::class, 'update']);
        Route::get('/product/delete/{id}', [ProductController::class, 'destroy']);
        Route::post('/delete-prototype',[ProductController::class, 'destroy_prototype']);
        Route::post('/product/product_id={product_id}/flag={flag}/add-data-to-existing',[ProductController::class,'add_data_to_existing']);

        Route::post('/key-points/store', [ProductController::class, 'key_points_insert']);
        Route::post('/key_point_id={id}/key-point-update/', [ProductController::class, 'key_point_update']);
        Route::post('/tech-save', [ProductController::class, 'tech_insert']);

        Route::post('/purpose', [ProductController::class, 'using_purpose_save']);
        Route::post('/purpose_id={id}/purpose-update/', [ProductController::class, 'benefit_update']);
        ...
        Route::get('/jobs', [JobController::class, 'index'])->name('jobs.get');
        Route::get('/jobs-lists', [JobController::class, 'get_all'])->name('jobs.get_all');
        Route::get('/jobs/edit/{job_id}', [JobController::class, 'edit'])->name('jobs.edit');
        Route::post('/jobs/store', [JobController::class, 'store'])->name('jobs.store');

        Route::post('/job_id={job_id}/responsibility-save',[ResponsibilityController::class,'store']);

        Route::post('/job_id={job_id}/requirements-save', [RequirementController::class, 'store']);

        Route::post('/job_id={job_id}/additional-save', [AdditionalController::class, 'store']);

        Route::get('/jobs/delete/{job_id}', [JobController::class, 'destroy']);
